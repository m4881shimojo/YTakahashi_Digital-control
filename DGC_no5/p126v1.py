...
wbeg=1.5;wend=2;dw=0.05;plot_color="g."       
root_log(wbeg,wend,dw,plot_color)

wbeg=0;wend=1.5;dw=0.01;plot_color="r."       
root_log(wbeg,wend,dw,plot_color)

wbeg=-2;wend=0;dw=0.01;plot_color="b."       
root_log(wbeg,wend,dw,plot_color)

wbeg=-2.8;wend=-2.;dw=0.01;plot_color="m."       
root_log(wbeg,wend,dw,plot_color)

wbeg=-3.6;wend=-2.8;dw=0.01;plot_color="y."       
root_log(wbeg,wend,dw,plot_color)

#wbeg=-5;wend=-4;dw=0.01;plot_color="w."
wbeg=-4.5;wend=-3.6;dw=0.001;plot_color="r."        
root_log(wbeg,wend,dw,plot_color)

#wbeg=-8;wend=-5;dw=0.01;plot_color="k." 
wbeg=-8;wend=-4.5;dw=0.01;plot_color="k."       
root_log(wbeg,wend,dw,plot_color)
