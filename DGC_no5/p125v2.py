...
#plot範囲の指定でグラフの様子は変わる(line 173あたり)
...
# Log plot #
##
wbeg=-2;wend=2;dw=0.1;plot_color="c."       
root_log(wbeg,wend,dw,plot_color)
plt.legend(loc='lower right')

wbeg=-5;wend=-2;dw=0.1;plot_color="g."       
root_log(wbeg,wend,dw,plot_color)

wbeg=-5.5;wend=-5;dw=0.02;plot_color="r."       
root_log(wbeg,wend,dw,plot_color)

wbeg=-5.8;wend=-5.5;dw=0.001;plot_color="b."       
root_log(wbeg,wend,dw,plot_color)

wbeg=-6;wend=-5.8;dw=0.0002;plot_color="m."       
root_log(wbeg,wend,dw,plot_color)

wbeg=-7;wend=-6;dw=0.05;plot_color="y*"       
root_log(wbeg,wend,dw,plot_color)

wbeg=-10;wend=-7;dw=0.05;plot_color="k."       
root_log(wbeg,wend,dw,plot_color)
