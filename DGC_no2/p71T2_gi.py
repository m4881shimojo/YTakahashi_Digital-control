...
#N=1 --> z^(N+1) --> z^(2) 
#Y[k]=-(a1*Y[k-1]+a2*Y[k-2])+(b1*U[k-2]+b2*U[k-3]+b3*U[k-4])  <--N=1
print("\nN,T,L,L1 :",N,T,L,L1)
#係数を(4-12)を用いて決める
#
...
# i= 8 0.8601067919709207 0.902571932245097 0.049371939241251876
#
#p71 (4-19)を求める
#b1=g1,b2=g2-p*g1,...bn=gn-p*g(n-1)
#
p1_hat=0.860 #書籍と同じ
Dnum=8 #書籍と同じ
...
#plt.plot(t,g,'-*r',label="g(j)")     #最終出力 
#plt.plot(t,bj,'-*b',label="b(j)") 
...
plt.text(xp,yp-Ymax/15, "g5={:.3g},g6={:.3g},g7={:.3g},g8={:.3g}".format(g[5],g[6],g[7],g[8]))
